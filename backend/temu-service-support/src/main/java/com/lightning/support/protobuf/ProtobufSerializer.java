...
public abstract class ProtobufSerializer<T extends MessageOrBuilder> extends StdSerializer<T> {
  ...
  protected void writeValue(
    ...
    writeValue(field, value, generator, serializerProvider, false);
  }
  ...
  protected void writeValue(
    ...
    switch (field.getJavaType()) {
      ...
      case ENUM:
        ...
        break;
      case BYTE_STRING:
        generator.writeString(serializerProvider.getConfig().getBase64Variant()
  ...
  private static IOException unrecognizedType(FieldDescriptor field, JsonGenerator generator)
      throws IOException {
    String error = format("Unrecognized java type '%s' for field %s", field.getJavaType(),
        field.getFullName());
