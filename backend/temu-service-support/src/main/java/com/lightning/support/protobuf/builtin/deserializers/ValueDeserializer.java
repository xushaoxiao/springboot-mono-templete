...
public class ValueDeserializer extends ProtobufDeserializer<Value, Builder> {

  private static final FieldDescriptor STRUCT_FIELD = Value.getDescriptor()
      .findFieldByName("struct_value");
  private static final FieldDescriptor LIST_FIELD = Value.getDescriptor()
  ...
  protected void populate(
    ...
    switch (parser.getCurrentToken()) {
      ...
      case VALUE_NUMBER_INT:
        builder.setNumberValue(parser.getValueAsLong());
        return;
      ...
      case VALUE_NULL:
        ...
        return;
      default:
        String message = "Can not deserialize instance of com.google.protobuf.Value out of "
  ...
  @Override
  public Builder getNullValue(DeserializationContext ctxt) {
